...
\subsection{} % f
See \figref{fig:3f}. The problem when using the noisy measurement directly is that the measurement (and the noise) is immediately introduced into the control system. This can be seen especially well by 
